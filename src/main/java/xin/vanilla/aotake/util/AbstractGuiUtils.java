...
public class AbstractGuiUtils {
    ...
    public static void drawString(PoseStack poseStack, Font font, String text, double x, double y, int argb) {
        AbstractGuiUtils.drawString(Text.literal(text).setColor(Color.argb(argb)).setPoseStack(poseStack).setFont(font), x, y);
    }
    ...
    public static void drawString(PoseStack poseStack, Font font, String text, double x, double y, int argb, boolean shadow) {
        AbstractGuiUtils.drawString(Text.literal(text).setColor(Color.argb(argb)).setShadow(shadow).setPoseStack(poseStack).setFont(font), x, y);
    }

    public static void drawString(Text text, double x, double y, EDepth depth) {
        AbstractGuiUtils.renderByDepth(text.getPoseStack(), depth, (stack) ->
    ...
    public static void drawMultilineText(PoseStack poseStack, Font font, String text, double x, double y, int... argbs) {
        AbstractGuiUtils.drawMultilineText(Text.literal(text).setPoseStack(poseStack).setFont(font), x, y, argbs);
    }
    ...
    public static void drawLimitedText(PoseStack poseStack, Font font, String text, double x, double y, int maxWidth, int argb) {
        AbstractGuiUtils.drawLimitedText(Text.literal(text).setPoseStack(poseStack).setFont(font).setColor(Color.argb(argb)).setShadow(true), x, y, maxWidth, 0, EnumEllipsisPosition.END);
    }
    ...
    public static void drawLimitedText(PoseStack poseStack, Font font, String text, double x, double y, int maxWidth, int argb, boolean shadow) {
        AbstractGuiUtils.drawLimitedText(Text.literal(text).setPoseStack(poseStack).setFont(font).setColor(Color.argb(argb)).setShadow(shadow), x, y, maxWidth, 0, EnumEllipsisPosition.END);
    }
    ...
    public static void drawLimitedText(PoseStack poseStack, Font font, String text, double x, double y, int maxWidth, EnumEllipsisPosition position, int argb) {
        AbstractGuiUtils.drawLimitedText(Text.literal(text).setPoseStack(poseStack).setFont(font).setColor(Color.argb(argb)).setShadow(true), x, y, maxWidth, 0, position);
    }
    ...
    public static void drawLimitedText(PoseStack poseStack, Font font, String text, double x, double y, int maxWidth, EnumEllipsisPosition position, int argb, boolean shadow) {
        AbstractGuiUtils.drawLimitedText(Text.literal(text).setPoseStack(poseStack).setFont(font).setColor(Color.argb(argb)).setShadow(shadow), x, y, maxWidth, 0, position);
    }
    ...
    public static void drawPopupMessage(PoseStack poseStack, Font font, String message, double x, double y, int screenWidth, int screenHeight, int margin, int padding, int textArgb, int bgArgb) {
        AbstractGuiUtils.drawPopupMessage(Text.literal(message).setPoseStack(poseStack).setFont(font).setColor(Color.argb(textArgb)), x, y, screenWidth, screenHeight, margin, padding, bgArgb);
    }
    ...
    public static void drawPopupMessage(Text text, double x, double y, int screenWidth, int screenHeight, int margin, int padding, int bgArgb, boolean inScreen) {
        ...
        AbstractGuiUtils.renderByDepth(text.getPoseStack(), EDepth.POPUP_TIPS, (stack) -> {
            // 在计算完的坐标位置绘制消息框背景
            GuiComponent.fill(text.getPoseStack(), (int) finalAdjustedX, (int) finalAdjustedY, (int) (finalAdjustedX + finalMsgWidth), (int) (finalAdjustedY + finalMsgHeight), bgArgb);
            // 绘制消息文字
