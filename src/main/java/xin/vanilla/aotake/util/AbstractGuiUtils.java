...
public class AbstractGuiUtils {
    ...
    public static Button newButton(int x, int y, int width, int height, Component content, Button.OnPress onPress, Component tooltip) {
        Button.Builder builder = Button.builder(content.toTextComponent(AotakeUtils.getClientLanguage()), onPress)
                .pos(x, y).size(width, height);
        if (tooltip != null)
            builder.tooltip(Tooltip.create(tooltip.toTextComponent(AotakeUtils.getClientLanguage())));
