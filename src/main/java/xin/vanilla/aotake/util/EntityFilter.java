                ...
                case PREDEFINED:
                    switch (d.payload) {
                        ...
                        case "entityResource":
                            ...
                            break;
                        case "itemResource":
                            if (itemResource == null && entity instanceof ItemEntity) {
                                itemResource = ItemUtils.getItemRegistryString(((ItemEntity) entity).getItem());
                            }
                            varsOut.put(key, itemResource);
                            break;
                        case "emptyItem":
                            if (emptyItem == null) {
                                emptyItem = entity instanceof ItemEntity
