...
public final class DustbinBaniraThemePaint {
    ...
    private static void drawHeaderSurface(MatrixStack stack, int guiLeft, int guiTop, int imageW,
                                          BaniraColorConfig t) {
    ...
    private static void drawDustbinSurface(MatrixStack stack, int guiLeft, int guiTop, int imageW,
    ...
    private static void drawPlayerInventorySurface(MatrixStack stack, int guiLeft, int guiTop,
