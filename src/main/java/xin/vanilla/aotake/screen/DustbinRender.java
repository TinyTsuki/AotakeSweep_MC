    ...
    public static void handleGuiScreen(ScreenEvent event) {
        ...
        if (event instanceof ScreenEvent.InitScreenEvent.Post eve) {
            ...
            if (dustbinUi == EnumDustbinClientUiStyle.TEXTURED || dustbinUi == EnumDustbinClientUiStyle.BANIRA_THEME) {
                ScreenEvent.DrawScreenEvent.Post eve = (ScreenEvent.DrawScreenEvent.Post) event;
                LocalPlayer player = mc.player;
            ...
            ScreenEvent.KeyboardKeyPressedEvent.Pre keyEvent = (ScreenEvent.KeyboardKeyPressedEvent.Pre) event;
