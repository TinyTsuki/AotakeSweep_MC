...
public class WorldCoordinate implements Serializable, Cloneable {
    ...
    public static WorldCoordinate readFromNBT(CompoundTag tag) {
        ...
        coordinate.dimension = ResourceKey.create(Registries.DIMENSION, AotakeSweep.parseIdentifier(tag.getString("dimension")));
        return coordinate;
    }
    ...
    public static WorldCoordinate fromJsonString(String jsonString) {
        ...
        coordinate.dimension = ResourceKey.create(Registries.DIMENSION, AotakeSweep.parseIdentifier(dimensionStr));
        return coordinate;
    }
    ...
    public static WorldCoordinate fromSimpleString(String str) {
        ...
        try {
            ...
            if (split.length == 5) {
                ResourceKey<Level> dimension = ResourceKey.create(Registries.DIMENSION, AotakeSweep.parseIdentifier(split[0].trim()));
