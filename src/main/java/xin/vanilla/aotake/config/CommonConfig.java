...
public class CommonConfig {
     ...
     * 缓存区物品限制
     */
    public static final ModConfigSpec.IntValue CACHE_LIMIT;
     ...
     * 打扫前提示语音
     */
    public static final ModConfigSpec.ConfigValue<String> SWEEP_WARNING_VOICE;

    /**
     * 打扫前提示语音音量
     */
    public static final ModConfigSpec.IntValue SWEEP_WARNING_VOICE_VOLUME;
     ...
     */
    public static final ModConfigSpec.IntValue SAFE_BLOCKS_ENTITY_LIMIT;
