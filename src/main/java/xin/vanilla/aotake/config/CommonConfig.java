        ...
        // 定义基础设置
        {
            ...
            SWEEP_WARNING_SECOND = SERVER_BUILDER
                    .comment("A warning sequence before sweeping."
                            ...
                            , "n=0：打扫成功时的提示；"
                            , "n=-1：打扫失败时的提示。")
                    .defineList("sweepWarningSecond", new ArrayList<Integer>() {{
                        add(-1);
                        add(0);
                        add(1);
                        add(2);
            ...
            SWEEP_WARNING_CONTENT = SERVER_BUILDER
                    ...
                    .defineList("sweepWarningContent", new ArrayList<String>() {{
            ...
            SAFE_BLOCKS_BELOW = SERVER_BUILDER
                    .comment("Entities will not be cleaned up if they are on these blocks."
                            ...
                            , "实体处于该方块上时不会被清理。"
                            , "支持带状态的方块id，如：minecraft:lava[level=0]")
                    .defineList("safeBlocksBelow", new ArrayList<String>() {{
                    }}, o -> o instanceof String);
            ...
            SAFE_BLOCKS_ABOVE = SERVER_BUILDER
                    .comment("Entities will not be cleaned up if they are below these blocks."
                            ...
                            , "实体处于该方块下时不会被清理。"
                            , "支持带状态的方块id，如：minecraft:lava[level=0]")
                    .defineList("safeBlocksAbove", new ArrayList<String>() {{
                    }}, o -> o instanceof String);
