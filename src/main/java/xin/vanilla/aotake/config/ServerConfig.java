...
public class ServerConfig {
     ...
     * 黑白名单实体超过指定数量也进行清理
     */
    public static final ModConfigSpec.IntValue ENTITY_LIST_LIMIT;

    /**
     * 仅清理不回收的实体
     */
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ENTITY_REDLIST;
     ...
     * 区块实体清理时保留的实体比例
     */
    public static final ModConfigSpec.DoubleValue CHUNK_CHECK_RETAIN;
     ...
     * 掉落统计文件数量上限
     */
    public static final ModConfigSpec.IntValue DROP_STATS_FILE_LIMIT;
     ...
     * 每tick清理实体上限
     */
    public static final ModConfigSpec.IntValue SWEEP_ENTITY_LIMIT;

    /**
     * 每批次清理间隔tick
     */
    public static final ModConfigSpec.IntValue SWEEP_ENTITY_INTERVAL;

    /**
     * 每次清理的批次上限
     */
    public static final ModConfigSpec.IntValue SWEEP_BATCH_LIMIT;
